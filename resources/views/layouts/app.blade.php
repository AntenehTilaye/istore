      ...
      <ul class="navbar-nav ms-auto d-flex flex-row">
        ...
        <li class="nav-item dropdown">
          ...
          <ul
              ...
              >
            <li><a class="dropdown-item" href="{{ route('admin.profile', Auth::guard('admin')->user()->id) }}">Profile</a></li>
            <li><a class="dropdown-item" href="{{ route('admin.setting', Auth::guard('admin')->user()->id) }}">Settings</a></li>
